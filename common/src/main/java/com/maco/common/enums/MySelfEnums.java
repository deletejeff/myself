...
public class MySelfEnums {
    public enum MySelfCommEnums {
        ...
        COUPON_STATUS_WRITE_OFF_ERROR1("10004", "优惠券未领取或已作废，不能核销"),
        COUPON_STATUS_WRITE_OFF_ERROR2("10007", "优惠券已核销过，不能再次核销"),
        COUPON_WRITE_OFF_START_TIME_ERROR("10005", "优惠券使用日期未到，不能核销"),
        COUPON_WRITE_OFF_END_TIME_ERROR("10006", "优惠券已过期，不能核销"),
